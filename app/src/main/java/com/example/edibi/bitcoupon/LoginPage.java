...
public class LoginPage extends ActionBarActivity {
    ...
    private static String TAG = "bitcamp.service.main_activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String email = sharedPref.getString(getString(R.string.user_email_key), null);
        String password = sharedPref.getString(getString(R.string.user_password_key), null);
    ...
    private Callback logResponse() {
        return new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                Log.d(TAG, "worked");
                //     Intent postInt = new Intent(MainActivity.this, SendPostActivity.class);
    ...
    {
        Intent postInt = new Intent(this, ListOfCoupons.class);
        startActivity(postInt);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_list_of_coupons , menu);
        return true;
    }
